...
# Shared Variables and Static values
SERVER_IP = "127.0.0.1"
MOTION_ENERGY_PORT = 1111

# OSC Sender
py_to_max_OscSender = SimpleUDPClient(SERVER_IP, MOTION_ENERGY_PORT)
...
class MotionEnergy:
    ...
    def send_packet(self, x, y):
        ...
        if self.verbose:
            print(f"Sending packet: /motion_energy/x: {x}, /motion_energy/y: {y}")
